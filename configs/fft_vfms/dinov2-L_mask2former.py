...
# do not train self.norm, self.ls (layer scale), pos_embed, and patch_embed
model = dict(type="FrozenNSEncoderDecoder")
...
# backbone_multi = dict(lr_mult=0.1, decay_mult=0.0)
# backbone_norm_multi = dict(lr_mult=0.)
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            # "backbone.patch_embed.norm": backbone_multi,
            # "backbone.pos_embed": backbone_multi,
