# dataset config
_base_ = [
    "../_base_/datasets/dg_c16_2cbm_1024x1024.py",
    "../_base_/default_runtime.py",
    "../_base_/models/dinov2_mask2former.py",
]
load_from = 'gsu2cbm_results/r16_16k_G1_1024res/sora_dinov2-L_gsu2cbm1024x1024_best.pth'
crop_size = (1024, 1024)
rank = 16
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        type="AdamW", lr=1e-05, weight_decay=0.05, eps=1e-8, betas=(0.9, 0.999)
    ),
    paramwise_cfg=dict(
        custom_keys={
...
default_hooks = dict(
    ...
    checkpoint=dict(
        type="CheckpointHook", by_epoch=False, interval=400, max_keep_ckpts=7
    ),
